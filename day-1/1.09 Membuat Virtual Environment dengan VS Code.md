...
## Tujuan Sesi
- Memahami pentingnya virtual environment untuk project isolation
- Mampu membuat virtual environment menggunakan GUI VS Code
- Mampu memilih dan mengaktifkan interpreter dari virtual environment
- Mampu menjalankan file Python dengan virtual environment
- Memahami best practices pengaturan `.gitignore` untuk virtual environment
