...
## Tujuan Sesi
- Memahami konsep Exploratory Data Analysis (EDA) dan pentingnya dalam data science
- Mampu melakukan loading dan inspeksi data menggunakan pandas
- Mampu mengidentifikasi kualitas data dan menangani missing values
- Mampu membuat visualisasi distribusi data dan hubungan antar fitur
- Mampu menginterpretasi insight dari analisis data untuk tahap selanjutnya
...
![Tampilan data pertama dengan head](images/1_Analisis_dan_EDA/1.png)
...
![Informasi data dan pengecekan nilai kosong](images/1_Analisis_dan_EDA/2.png)
...
![Statistik deskriptif dataset Iris](images/1_Analisis_dan_EDA/3.png)
...
![Hasil penghapusan kolom Id](images/1_Analisis_dan_EDA/4.png)
...
![Histogram distribusi fitur SepalLengthCm](images/1_Analisis_dan_EDA/5a.png)
![Histogram distribusi semua fitur dengan KDE](images/1_Analisis_dan_EDA/5b.png)
**Penjelasan:**
...
![Scatter plot PetalLength vs PetalWidth per spesies](images/1_Analisis_dan_EDA/6.png)
...
![Heatmap korelasi antar fitur Iris](images/1_Analisis_dan_EDA/7.png)
