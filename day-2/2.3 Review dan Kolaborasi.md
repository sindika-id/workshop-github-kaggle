...
![Tombol Share di Kaggle notebook](images/3_Review_dan_Kolaborasi/1a.png)

3. Pilih **"Public"**
4. Salin **URL notebook publik** (misal: `https://www.kaggle.com/username/nama-notebook`)
5. Kemudian save

![Menu pengaturan akses notebook Kaggle ke Public](images/3_Review_dan_Kolaborasi/1b.png)
