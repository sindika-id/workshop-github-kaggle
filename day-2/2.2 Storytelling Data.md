...
![Proses pembersihan data Iris dataset](images/2_Storytelling_Data/2.png)
...
![Histogram distribusi semua fitur Iris dataset](images/2_Storytelling_Data/3a.png)
...
![Scatter plot perbandingan fitur Sepal dan Petal per spesies](images/2_Storytelling_Data/3b.png)
...
![Heatmap korelasi lengkap antar fitur Iris](images/2_Storytelling_Data/3c.png)
...
![Violin plot distribusi fitur per spesies Iris](images/2_Storytelling_Data/3d.png)
...
![Proses pelatihan dan evaluasi model machine learning](images/2_Storytelling_Data/4a.png)

### K-Nearest Neighbors

![Hasil training KNN - classification report](images/2_Storytelling_Data/4b.png)
![Confusion matrix KNN untuk dataset Iris](images/2_Storytelling_Data/4c.png)
...
![Hasil training Logistic Regression - classification report](images/2_Storytelling_Data/4d.png)
![Confusion matrix Logistic Regression untuk dataset Iris](images/2_Storytelling_Data/4e.png)
