...
### B. Opsi 2: Save to GitHub (Push/Sync)
...
5. Isi **Commit Message** sesuai konvensi conventional commit (misal `feat: add iris knn training`).
...
```
![README.md dengan link ke Kaggle notebook](images/6_Publikasi_dan_Integrasi_Github_Kaggle/4.png)
